...
Returns:
    mean_absolute_error: If multioutput is `raw_values`, then mean absolute
    ...
    The MAE output is a non-negative floating point. The best value is 0.0.

Examples:
    >>> from molflux.metrics import load_metric
    >>> metric = load_metric("mean_absolute_error")
...
class MeanAbsoluteError(HFMetric):
