...
from molflux.features.representations.openeye.descriptors.num_acceptors import (
    NumAcceptors,
)

representation_name = "num_acceptors"
...
def test_representation_is_mapped_to_correct_class(fixture_representation):
    ...
    assert isinstance(representation, NumAcceptors)
