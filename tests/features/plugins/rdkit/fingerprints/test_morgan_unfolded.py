...
from molflux.features.representations.rdkit.fingerprints.morgan_unfolded import (
    MorganUnfolded,
)

representation_name = "morgan_unfolded"
...
def test_representation_is_mapped_to_correct_class(fixture_representation):
    ...
    assert isinstance(representation, MorganUnfolded)
