...
from molflux.features.representations.rdkit.fingerprints.atom_pair_unfolded import (
    AtomPairUnfolded,
)

representation_name = "atom_pair_unfolded"
...
def test_representation_is_mapped_to_correct_class(fixture_representation):
    ...
    assert isinstance(representation, AtomPairUnfolded)
