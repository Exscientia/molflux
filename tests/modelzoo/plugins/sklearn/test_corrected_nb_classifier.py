...
from molflux.modelzoo.models.sklearn.corrected_nb_classifier import (
    CorrectedNBClassifier,
)
from molflux.modelzoo.protocols import Estimator, Model, supports_classification

model_name = "corrected_nb_classifier"
...
def test_is_mapped_to_correct_class(fixture_model):
    ...
    model = fixture_model
    assert isinstance(model, CorrectedNBClassifier)
