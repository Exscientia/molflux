...
from molflux.modelzoo.models.sklearn.coverage_nb_classifier import (
    CoverageNBClassifier,
)
from molflux.modelzoo.protocols import Estimator, Model, supports_classification

model_name = "coverage_nb_classifier"
...
def test_is_mapped_to_correct_class(fixture_model):
    ...
    model = fixture_model
    assert isinstance(model, CoverageNBClassifier)
