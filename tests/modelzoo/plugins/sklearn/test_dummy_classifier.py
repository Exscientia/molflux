...
from molflux.modelzoo.models.sklearn.dummy_classifier import DummyClassifier
...
def test_scikit_learn_examples(fixture_model):
    """That can reproduce the example given in the scikit-learn documentation for this model"""
