...
from molflux.modelzoo.models.sklearn.linear_discriminant_analysis_classifier import (
    LinearDiscriminantAnalysisClassifier,
)
from molflux.modelzoo.protocols import Estimator, Model, supports_classification

model_name = "linear_discriminant_analysis_classifier"
...
def test_is_mapped_to_correct_class(fixture_model):
    ...
    model = fixture_model
    assert isinstance(model, LinearDiscriminantAnalysisClassifier)
