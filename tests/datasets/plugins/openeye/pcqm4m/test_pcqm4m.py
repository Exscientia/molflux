...
from molflux.datasets.builders.pcqm4m_v2.pcqm4m_v2 import PCQM4MV2
from molflux.datasets.catalogue import list_datasets

dataset_name = "pcqm4m_v2"
...
def _fixture_mocked_dataset_asset(fixture_path_to_mock_data):
    ...
    with patch("datasets.builder.DownloadManager.download_and_extract") as mock:
        mock.return_value = {
            "mols_file": str(fixture_path_to_mock_data),
            "dataset_file": str(fixture_path_to_mock_data),
        }
        yield
